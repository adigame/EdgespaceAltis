...
switch(_type) do
{
	...
	case "187V": {_type = ["Vehiclular Murder (VDM)",120000]};
	case "187": {_type = ["Murder",1234567]};
	case "901": {_type = ["Escaping Jail",1234567]};
    ...
    case "30": {_type = ["Bank Robbery",1234567]};
	...
	case "120FS": {_type = ["Reckless Driving",8000]};
