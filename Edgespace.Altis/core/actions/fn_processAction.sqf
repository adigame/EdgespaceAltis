...
*/
private["_vendor","_type","_itemInfo","_oldItem","_newItem","_cost","_upp","_hasLicense","_itemName","_oldVal","_ui","_progress","_pgText","_cP","_data"];
...
diag_log "------------ fn_processAction.sqf --------------";
diag_log format["_profName: %1",_profName];
//diag_log format["_data: %1",_data select 0];
diag_log "------------------------------------------------";
	...
	if( _profName != "" ) then 
	{
		switch ( _data select 0 ) do
			{
				case 1: { _time = 2.0; _cpUp = 0.01; };
				case 2: { _time = 1.95; _cpUp = 0.01; };
				case 3: { _time = 1.9; _cpUp = 0.02; };
				case 4: { _time = 1.85; _cpUp = 0.02; };
				case 5: { _time = 1.8; _cpUp = 0.03; };
				case 6: { _time = 1.7; _cpUp = 0.03; };
				case 7: { _time = 1.5; _cpUp = 0.04; };
				case 8: { _time = 1.3; _cpUp = 0.04; };
				case 9: { _time = 1.1; _cpUp = 0.05; };
				case 11: { _time = 0.9; _cpUp = 0.05; };
				case 12: { _time = 0.7; _cpUp = 0.06; };
				case 13: { _time = 0.5; _cpUp = 0.06; };
				case 14: { _time = 0.3; _cpUp = 0.07; };
				case 15: { _time = 0.1; _cpUp = 0.07; };
			};
	};
while{true} do
{
