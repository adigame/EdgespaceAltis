...
if (license_civ_rebel) exitWith { hint "Rebels cannot use this."; }; //shouldn't be needed
...
_search = player addAction ["Search Wreck", "core\jobs\treasure_hunting\fn_SearchWreck.sqf"];
};
