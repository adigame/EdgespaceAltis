...
_potteryage = ["10,000BC","12,000BC","15,000BC","17,000BC"] call BIS_fnc_selectRandom;

	If (life_inv_roundobject == 1) then {
	hintC format ["This appears to be some kind of stone carving, and is atleast 1000 years old based on similar pieces I have seen, I would say this is worth around $100000."];
	...
	hintC format ["These coins are extremely valuable, and will be worth around $250000."];
	life_inv_coins = 0;
