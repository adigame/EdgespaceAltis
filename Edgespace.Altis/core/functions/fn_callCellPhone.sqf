...
if ((player getVariable ["restrained", false]) || (player getVariable ["surrender", false]) || (player getVariable ["ziptied", false])) exitWith {hint "You cant do that you are tied up!"};
