...
for "_i" from 1 to 22 do {_cellblock1 setVariable[format["bis_disabled_Door_%1",_i],0,false]; _cellblock1 animate [format["Door_%1_rot",_i],1];};
for "_i" from 1 to 22 do {_cellblock2 setVariable[format["bis_disabled_Door_%1",_i],0,false]; _cellblock2 animate [format["Door_%1_rot",_i],1];};
for "_i" from 1 to 22 do {_cellblock3 setVariable[format["bis_disabled_Door_%1",_i],0,false]; _cellblock3 animate [format["Door_%1_rot",_i],1];};

_cellblock1 allowDamage false;
_cellblock2 allowDamage false;
_cellblock3 allowDamage false;

systemChat "Mass Prisoner release Initiated.";
