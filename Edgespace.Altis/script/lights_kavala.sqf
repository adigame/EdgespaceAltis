if (life_kw_kavala) exitWith {hint "You have already initiated load shedding in Kavala you will need to wait 10 minutes"};
...
if(playerSide == civilian) then
{
	...
	[[0,format["!!! Load shedding has stopped Kavala !!!", name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
	hint "!!! load shedding has stopped Kavala !!!";
};