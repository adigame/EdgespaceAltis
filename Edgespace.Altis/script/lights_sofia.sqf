if (life_kw_sofia) exitWith {hint "Do have already initiated load shedding"};
...
if(playerSide == civilian) then
{
	...
	[[0,format["!!! %1 has started load shedding in Sofia !!!", name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
	sleep 300;
	life_kw_sofia = false;
};