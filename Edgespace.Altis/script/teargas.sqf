...
[] spawn {
	while {true} do 
	{
		...
		if (vest player != "V_PlateCarrier1_blk") then {antidote1 = 2583}; // Player has no Suit
		if (vest player == "V_PlateCarrier1_blk") then {antidote1 = 2581}; // Player carries the Gas Suit
